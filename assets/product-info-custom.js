document.addEventListener('DOMContentLoaded', () => {
    try {
        ...
        const updateURLWithVariant = (variantId) => {
            if (variantId) {
                const url = new URL(window.location.href);
                url.searchParams.set('variant', variantId); // Update of voeg toe
                window.history.replaceState({}, '', url.toString()); // Vervang de URL zonder opnieuw te laden
            }
        };
        ...
        const handleSelectionChange = () => {
            ...
            if (selectedVariant) {
                ...
                updateGallery(selectedVariant.id.toString());
        ...
        updateGallery(initialVariant.id.toString());
